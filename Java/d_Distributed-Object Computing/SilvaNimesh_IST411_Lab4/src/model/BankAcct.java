...
Using the JSON API in Java, it is converting that data from the JSON format into a Java object by creating a class that mirrors the structure of the JSON data.
