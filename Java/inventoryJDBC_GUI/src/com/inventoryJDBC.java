...
public class inventoryJDBC extends JFrame implements ActionListener {
    ...
    public inventoryJDBC() throws ClassNotFoundException, SQLException {
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        inventoryJDBC ex = new inventoryJDBC();
