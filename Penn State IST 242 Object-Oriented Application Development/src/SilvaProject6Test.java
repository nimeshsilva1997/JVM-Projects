...
public class SilvaProject6Test extends JFrame implements ActionListener {
	...
	public SilvaProject6Test() throws ClassNotFoundException, SQLException {
	...
	public void getPartUpdate() throws SQLException, ClassNotFoundException {
		sqlNumber = 22222;
		Class.forName("com.mysql.jdbc.Driver");
		System.out.println("Driver loaded");
		// Establish a connection
	...
	public void getPartDeleteRecord() throws SQLException, ClassNotFoundException {
		Class.forName("com.mysql.jdbc.Driver");
		System.out.println("Driver loaded");
		// Establish a connection
		Connection connection = DriverManager.getConnection("jdbc:mysql://localhost/test", "root", "");
	...
	public void actionPerformed(ActionEvent action) {
		...
		if (action.getActionCommand().equals("Read")) {
		...
		} else if (action.getActionCommand().equals("Update")) {
			try {
				inputNumber = number.getText();
				sqlNumber = Integer.parseInt(inputNumber);
				getPartUpdate();
			...
			if (inputUpdate == JOptionPane.OK_OPTION) {
				...
				// will change after UPDATE is made
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		SilvaProject6Test ex = new SilvaProject6Test();
